...
class CustomFloatingTextField extends StatelessWidget {
  ...
  Widget get floatingTextFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumInterGray900,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodySmallErrorContainer12,
        labelText: labelText ?? "",
        ...
        isDense: true,
        contentPadding:
            contentPadding ?? EdgeInsets.fromLTRB(10.h, 28.v, 10.h, 10.v),
        fillColor: fillColor,
        filled: filled,
